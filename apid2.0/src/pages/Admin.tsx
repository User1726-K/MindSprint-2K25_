...
const Admin = () => {
  ...
  const recentAlerts = [
    {
      type: "urgent",
      message: "3 high-priority booking requests pending",
      time: "2 minutes ago",
      action: "Review Cases"
    },
    {
      type: "trend",
      message: "40% increase in anxiety-related posts this week",
      time: "1 hour ago",
      action: "View Trends"
    },
    {
      type: "resource",
      message: "Depression support guide viewed 150+ times today",
      time: "3 hours ago",
                    ...
                    <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex items-center space-x-3">
                        <div className={`w-3 h-3 rounded-full ${
                          ...
                          alert.type === 'trend' ? 'bg-yellow-500' : 'bg-blue-500'
                        }`}></div>
                        <div>
